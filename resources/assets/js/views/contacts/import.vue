                        ...
                        <div class="m-portlet__body">
                            <div class="m-form__section m-form__section--first">
                                ...
                                <!-- <div class="form-group m-form__group row" :class="errors.has('group') || validationErrors.group ? 'has-error' : ''">
                                    ...
                                    <div class="col-lg-6">
                                        <v-select :options="options" v-validate="'required'" :multiple="true" data-vv-name="group" name="group" v-model="contact.group" @keydown.enter.native="preventOnEnter($event)"></v-select>
